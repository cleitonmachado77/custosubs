import { Activity, ChevronLeft, FileSpreadsheet, GraduationCap, LayoutDashboard, MapPin, Menu, X } from 'lucide-react'
...
export function EduSidebar({ activeScreen, onNavigate, onBackToLanding }: EduSidebarProps) {
  ...
  function handleNav(screen: 'edu-home' | 'edu-dashboard' | 'edu-importar') {
    onNavigate(screen)
    setMobileOpen(false)
  }
  ...
  return (
    <>
      ...
      <aside className={`edu-sidebar sidebar-scroll ${mobileOpen ? 'open' : ''}`}>
