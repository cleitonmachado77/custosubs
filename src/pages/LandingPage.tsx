...
interface LandingPageProps {
  onEnterModule: (module: 'saude') => void
}
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-16">
        ...
        <div className="flex flex-wrap justify-center gap-6 w-full max-w-3xl">
          ...
          {/* Módulos em breve */}
          {[
            { label: 'SICM-Educação',       desc: 'Rede de ensino municipal' },
            { label: 'SICM-Infraestrutura', desc: 'Obras e serviços urbanos' },
          ].map((mod) => (
            <div
              key={mod.label}
            ...
            >
              ...
              <div className="text-center">
                <p className="text-lg font-extrabold text-gray-400 leading-tight">{mod.label}</p>
                <p className="text-xs text-gray-300 mt-1">{mod.desc}</p>
              </div>
